...
void BufferSet::selectBuffers( GLuint program,
    ...
    GLuint vPosition = glGetAttribLocation( program , vp );
    ...
    if( vc != NULL ) {
        GLuint vColor = glGetAttribLocation( program, vc );
    ...
    if( vn != NULL ) {
        GLuint vColor = glGetAttribLocation( program, vn );
        glEnableVertexAttribArray( vColor );
    ...
    if( vt != NULL ) {
        GLuint vColor = glGetAttribLocation( program, vt );
        glEnableVertexAttribArray( vColor );
